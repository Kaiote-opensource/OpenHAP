...
{             
    ...
    esp_err_t ret = i2c_master_cmd_begin(MLX90640_inst->i2c_port, i2c_cmd, 1000 / portTICK_RATE_MS);
    ...
    //ESP_LOG_BUFFER_HEX_LEVEL("I2C UINT8 BUFFER", data_rd, 2*nMemAddressRead, ESP_LOG_DEBUG);
